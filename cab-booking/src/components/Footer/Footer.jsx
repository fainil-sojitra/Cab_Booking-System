        ...
        <Row>
          <Col lg="4" md="4" sm="12">
            ...
            <p className="footer__logo-content">
              ...
              protect your personal information by reading our privacy policy.
              Copyright © CAB_BOOKING_SYSTEM
              <br />
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Email: cabbooking7997@gmail.com</p>

              <p className="office__info">Office Time: 09:00 am - 11:00 pm</p>
            </div>
          </Col>
          ...
          <Col lg="12">
            <div className="footer__bottom">
              <p className="section__description d-flex align-items-center justify-content-center gap-1 pt-4">
                ...
                by CAB_BOOKING_SYSTEM. All rights reserved.
              </p>
            </div>
          </Col>
        </Row>
